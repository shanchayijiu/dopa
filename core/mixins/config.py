...
class ConfigMixin:
    ...
    def _init_config_handlers(self):
        ...
        aim_key_group.register_item('min_lead_speed', 'min_lead_speed', float, self.refresh_controller_params)
        aim_key_group.register_item('max_lead', 'max_lead', float, self.refresh_controller_params)
        aim_key_group.register_item('lead_smooth', 'lead_smooth', float, self.refresh_controller_params)
